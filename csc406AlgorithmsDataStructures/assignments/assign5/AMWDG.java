...
public class AMWDG extends DAG {
	...
	protected void constructAD() {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				final int weight = Integer.parseInt(lineArray[2]);
				final Node node1 = new Node(nodei);
				final Node node2 = new Node(nodej);
				final Edge e = new Edge(node1, node2, weight);
	...
	public boolean equals(Object child) { // note the type of the parameter
		final AMWDG c = (AMWDG) child; // cast the parameter before use
	...
	protected int[][] getAM() {
		if (AM != null) {
			...
			throw new NullPointerException(
					"The Weighted Adjacency Matrix has not been created yet");
		}
	}
