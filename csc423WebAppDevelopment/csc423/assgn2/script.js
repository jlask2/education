function firstnameValidity() {
    ...
    if (v == true) {
        ...
        error = "First name not in correct format: should have only letters and hyphens, the first letter"+                 
...
function miValidity() {
    ...
    if (v == true) {
        ...
        error = "Middle initial not in correct format: should have only a single capital letter or left " +                 
"blank\n\n";
        w.style.backgroundColor = 'pink';
	return error;   
    }
...
function lastnameValidity() {
    ...
    if (v == true) {   
        ...
        error = "Last Name not in correct format: should have only letters, apostraphe's, spaces and " +                       
"hyphens, the first letter should be capitalized\n\n";
        w.style.backgroundColor = 'pink';
        return error;
    }
...
function addressValidity() {
    ...
    var v = /^[0-9]+[a-zA-z\.\- ]+$/.test(w.value);
    if (v == true) {
        w.style.backgroundColor = 'lightgreen';
        return error;
    } else {
        error = "Address not in correct format: should have only numbers, periods, hyphens and letters, " +                 
"start with the number followed by the name of the street\n\n";
        w.style.backgroundColor = 'pink';
        return error;
    }
...
function monthdobValidity() {
    ...
    if(v == true) {
        ...
        error = "DOB Month not in correct format: should have exactly 2 digits corresponding to a valid" +                 
...
function yeardobValidity() {
    ...
    if(v == true) {
        ...
        error = "DOB Year not in correct format: should have exactly 4 digits corresponding to a valid" +                   
"year, between 1912 and 1998\n\n";
        w.style.backgroundColor = 'pink';
        return error;
    }
