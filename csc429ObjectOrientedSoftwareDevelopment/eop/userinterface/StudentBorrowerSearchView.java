...
public class StudentBorrowerSearchView extends ViewL{
	//GUI Components
	...
	public StudentBorrowerSearchView(IModel trans){
		super(trans, "StudentBorrowerSearchView");
		///
	...
	public void processCancel(){
		myModel.stateChangeRequest("CancelModifyStudentBorrower", null);
	}
