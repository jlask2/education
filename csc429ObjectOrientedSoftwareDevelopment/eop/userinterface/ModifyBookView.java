...
public class ModifyBookView extends ViewL{
	//GUI components
	...
	public ModifyBookView(IModel trans){
		super(trans, "ModifyBookView");
		///
	...
	public void populateFields(){
      ...
      bookConditionComboBox.addItem("Fair");
		...
		bookToModifyProps = (Properties)myModel.getState("deep_props_book_to_modify");
	...
	public void processSubmit(){
      setValidationMarkersOff();
		...
		if(myErrorMessage.equals("")){
			...
			setGUIOptions();
			int confirmation = confirmPopUp("Modify Book", 
			...
			if(confirmation == 0){
				...
				if(myMessage.equals("Book updated successfully.")){
					acknowledgePopUp("Modify Book",
