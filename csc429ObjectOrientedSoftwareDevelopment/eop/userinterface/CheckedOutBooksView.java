...
public class CheckedOutBooksView extends ViewL implements ActionListener, MouseListener{
	...
	//constructor
	public CheckedOutBooksView(IModel trans){
		super(trans, "CheckedOutBooksView");
