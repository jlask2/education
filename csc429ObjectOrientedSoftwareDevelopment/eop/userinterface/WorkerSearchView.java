...
public class WorkerSearchView extends ViewL{
	//GUI Components
	...
	public WorkerSearchView(IModel trans){
		super(trans, "WorkerSearchView");
		///
	...
	private void constructFields(){
		...
		includedInactiveCheckBox = new JCheckBox("Include Inactive Workers");
	...
	public void populateFields(){
		if(((String)myModel.getState("TransactionType")).equals("DeleteWorkerTransaction")){
	...
	public void processBannerID(){  
		...
		if(myErrorMessage.equals("")){
			myModel.stateChangeRequest("GetWorkerByBannerID", bannerIDTextField.getText());
