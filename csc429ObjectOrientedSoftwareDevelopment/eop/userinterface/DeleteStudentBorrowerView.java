...
public class DeleteStudentBorrowerView extends ViewL{
	//GUI components
	...
	private JLabel dateOfLastBorrowerStatusLabel;
	private JTextField dateOfLastBorrowerStatusTextField;
	...
	private Properties studentBorrowerToDeleteProps;

	private Properties deletedProperties;

	private Properties guiStatus;

	public DeleteStudentBorrowerView(IModel trans){
		super(trans, "DeleteStudentBorrowerView");		
		///
		...
		viewTitle = "    Delete Student Borrower";
		refreshLogoTitle();
	}
	@Override
	...
	public void populateFields(){
		...
		studentBorrowerToDeleteProps = (Properties)myModel.getState("deep_props_student_borrower_to_delete");

		bannerIDTextField.setText(studentBorrowerToDeleteProps.getProperty("BannerID"));
		firstNameTextField.setText(studentBorrowerToDeleteProps.getProperty("FirstName"));
		lastNameTextField.setText(studentBorrowerToDeleteProps.getProperty("LastName"));
		contactPhoneTextField.setText(studentBorrowerToDeleteProps.getProperty("ContactPhone"));
		emailTextField.setText(studentBorrowerToDeleteProps.getProperty("Email"));
		monetaryPenaltyTextField.setText(studentBorrowerToDeleteProps.getProperty("MonetaryPenalty"));
		notesTextArea.setText(studentBorrowerToDeleteProps.getProperty("Notes"));
		borrowerStatusComboBox.setSelectedItem(studentBorrowerToDeleteProps.getProperty("BorrowerStatus"));

		String dateOfFirstRegistration = studentBorrowerToDeleteProps.getProperty("DateOfFirstRegistration");
		...
		statusComboBox.setSelectedItem(studentBorrowerToDeleteProps.getProperty("Status"));
	...
	public void processSubmit(){
		getInputInformation();
		String myMessage = "";
		int confirmation = confirmPopUp("Delete Student Borrower", 
				"Are you sure you want to delete this student borrower?");
		if(confirmation == 0){
			myModel.stateChangeRequest("Submit", deletedProperties);
			myMessage = (String)myModel.getState("TransactionError");
			acknowledgePopUp("Delete Student Borrower", myMessage);
			myModel.stateChangeRequest("CancelThisView", null);
		}
		else{
			myMessage = "Student Borrower deletion cancelled.";
		}
	}
	...
	public void getInputInformation(){
		...
		deletedProperties.setProperty("BorrowerStatus", (String)borrowerStatusComboBox.getSelectedItem());
		deletedProperties.setProperty("DateOfLatestBorrowerStatus", studentBorrowerToDeleteProps.getProperty("DateOfLatestBorrowerStatus"));
		deletedProperties.setProperty("DateOfFirstRegistration", convertDateToString(yearComboBox.getSelectedItem(), monthComboBox.getSelectedItem(), dayComboBox.getSelectedItem()));	
		deletedProperties.setProperty("MonetaryPenalty", monetaryPenaltyTextField.getText());
